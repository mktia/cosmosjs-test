...
export class CustomBaseAccount implements Account {
  public static fromJSON(obj: any): CustomBaseAccount {
    if (obj.height) {
      obj = obj.result;
    }
    ...
    if (obj.value) {
      ...
      return new CustomBaseAccount(address, pubKey, accountNumber, sequence, coins);
    } else {
